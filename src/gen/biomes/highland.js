// PLACEHOLDER — replaced wholesale by the highland builder.
...
export function paintHighland(stage) {
  ...
  const st = rng.stream('highland');
  const spec = { desert: ['dune', 2.5, 2.0], shore: ['shore', 3.0, 1.2], highland: ['highland', 3.5, 3.2] }['highland'];
  const P = {

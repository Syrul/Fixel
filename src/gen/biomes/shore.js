// PLACEHOLDER — replaced wholesale by the shore builder.
...
export function paintShore(stage) {
  ...
  const st = rng.stream('shore');
  const spec = { desert: ['dune', 2.5, 2.0], shore: ['shore', 3.0, 1.2], highland: ['highland', 3.5, 3.2] }['shore'];
  const P = {
